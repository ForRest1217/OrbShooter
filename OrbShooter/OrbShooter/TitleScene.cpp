...
void RenderInfo(const GameState& state)
{
    ...
    DrawCenterWText(20, L"● : 일반 오브 - 능력 없음          ", Color::WHITE);
    DrawCenterWText(22, L"◎ : 폭탄 오브 - 없어질 때 주변 8칸 삭제", Color::WHITE);
    DrawCenterWText(24, L"◐ : 조커 오브 - 어떤 색으로든 변할 수 있음", Color::WHITE);
